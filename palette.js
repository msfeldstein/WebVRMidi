...
var Palette = function(controller, options) {
  ...
  controller.on(controller.PadTouched, this.onPadTouched.bind(this))
  controller.on(controller.PadUntouched, this.onPadUntouched.bind(this))

  controller.on(controller.PadDragged, function(dx, dy) {
